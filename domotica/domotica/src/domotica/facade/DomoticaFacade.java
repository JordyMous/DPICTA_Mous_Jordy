...
import domotica.command.Close;
import domotica.command.Door;
import domotica.model.*;

public class DomoticaFacade implements Close {

	House house;

	private Door theDoor;

	public DomoticaFacade (Door theDoor) {
		this.theDoor = theDoor;
	}

	public void execute () {
		theDoor.setAllDoorsClosed(house);
		theDoor.setAllDoorOpen(house);
	}
